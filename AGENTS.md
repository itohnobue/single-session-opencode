...
| `executor` | The single executor for all work types — executes the assembled task (plain: task context is the briefing; with briefing: template → RESEARCH DATA → task). No research of its own. |
